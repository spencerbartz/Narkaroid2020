...
public class PausableMp3Player {
	private URL urlToStreamFrom;
	private Bitstream bitstream;
	private Decoder decoder;
	private AudioDevice audioDevice;
	private Mp3PlaybackListener listener;
	 ...
	 */
	public PausableMp3Player(URL urlToStreamFrom, Mp3PlaybackListener listener) throws JavaLayerException {
	...
	public void pause() {
		this.isPaused = true;
		this.close();
		this.listener.playbackPaused(new Mp3PlaybackEvent(this, Mp3PlaybackEvent.EventType.Instances.Paused, this.frameIndexCurrent));
	}
	...
	public boolean play(int frameIndexStart, int frameIndexFinal, int correctionFactorInFrames) throws JavaLayerException {
		...
		if (this.listener != null) {
			this.listener.playbackStarted(new Mp3PlaybackEvent(this, Mp3PlaybackEvent.EventType.Instances.Started, this.frameIndexCurrent));
		}
		...
		if (this.audioDevice != null) {
			...
			if (this.listener != null && this.isPaused == false) {
				this.listener.playbackFinished(new Mp3PlaybackEvent(this, Mp3PlaybackEvent.EventType.Instances.Finished, this.frameIndexCurrent));
			}
		}
	...
	public void stop() {
		this.close();
		this.listener.playbackStopped(new Mp3PlaybackEvent(this, Mp3PlaybackEvent.EventType.Instances.Stopped, this.frameIndexCurrent));
	}
}
